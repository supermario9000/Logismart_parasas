...
void paras_generator(string vardas_pavarde, string pareigos, string elpastas, string numeris, string kalba)
{
    string pavadinimas;
    cout<<"Kaip noresite pavadinti paraso faila?: ";
    cin>>pavadinimas;
    ofstream lt(pavadinimas + ".html");
    lt<<"<body>\n<em>Pagarbiai, Best Regards, Freundliche Grüße, </em><br /><br />\n<p style=\"padding-left:8px; margin:0\"><strong>"<<vardas_pavarde<<"</strong><br />\n"<<pareigos<<" <br />\n</p>\n"<<endl;

    lt<<"<table style=\"font-family: Arial, sans-serif; font-size: 14px; color: #333;\">\n"
      <<"<tr>\n  <td style=\"padding-left: 8px;\">\n  <a href=\"mailto:"<<elpastas<<"\">\n"
    ...
    lt<<"</td>\n  <td>\n"
      <<"<a href=\""<<elpastas<<"\">"<<elpastas<<"</a><br />"<<endl;
    if(numeris!="nera")lt<<"<a href=\"tel:"<<numeris<<"\">"<<numeris<<"</a><br />"<<endl;
    ...
    lt.close();
    cout<<"Paraso .html failas sukurtas!"<<endl;
}
